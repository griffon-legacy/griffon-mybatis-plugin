 ...
 */
public class MybatisAwareProcessor extends AbstractGriffonLombokClassProcessor implements MybatisAwareConstants {
    private static final String MYBATIS_PROVIDER_FIELD_INITIALIZER = DEFAULT_MYBATIS_PROVIDER_TYPE + ".getInstance()";

    public MybatisAwareProcessor() {
        super(MybatisAware.class, PsiMethod.class);
    }
