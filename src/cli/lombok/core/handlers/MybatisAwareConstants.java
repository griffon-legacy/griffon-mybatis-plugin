...
public interface MybatisAwareConstants extends BaseConstants {
    String MYBATIS_PROVIDER_TYPE = "griffon.plugins.mybatis.MybatisProvider";
    String DEFAULT_MYBATIS_PROVIDER_TYPE = "griffon.plugins.mybatis.DefaultMybatisProvider";
    String MYBATIS_CONTRIBUTION_HANDLER_TYPE = "griffon.plugins.mybatis.MybatisContributionHandler";
    String MYBATIS_PROVIDER_FIELD_NAME = "this$MybatisProvider";
    String METHOD_GET_MYBATIS_PROVIDER = "getMybatisProvider";
    String METHOD_SET_MYBATIS_PROVIDER = "setMybatisProvider";
